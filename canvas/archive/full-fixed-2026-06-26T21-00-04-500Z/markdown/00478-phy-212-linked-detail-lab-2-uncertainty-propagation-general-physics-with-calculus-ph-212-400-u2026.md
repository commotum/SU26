...
- Captured: 2026-06-26T21:21:44.668Z
...
Compute your average distance, , and its uncertainty, . Compute your average time, , and its uncertainty, .
...
Q3: Calculate your walking speed  and propagate uncertainty to find the uncertainty in your speed: . Report each group members values in the report in the form .
...
Record wave-interval times at four different points in the video (representing different times of day / camera views). Organize your measurements in a data table and include each group member’s table in your report. Compute the average wave period  by dividing the total elapsed time by the number of intervals:  = (total time) / (# wave intervals). You have enough time per camera view to record at least 2 wave intervals.
Estimate the uncertainty in the wave period using the spread in your measured intervals (use half-range or standard deviation, depending on course convention), and report your result in the form: . Report each group member’s wave period and uncertainty in the report.
...
Report your result as . Briefly explain what your group uncertainty represents. Does it mostly reflect real differences in how fast people in your group walk, or measurement uncertainty within each person’s data collection? Use evidence to support your answer.

➤  Compare how large the spread between group members’ speeds is vs. how large each person’s individual uncertainty was () and describe which contribution appears larger and why.
...
Report your result as . Briefly explain what your group uncertainty represents. Does it mostly reflect differences in timing reaction and viewing choices or real variability in the waves? Use evidence to support your answer.
...
Choose a fraction of the wave period, , a person would have to react: . Briefly explain your reasoning.
...
➤  If the reaction time is , the propagated uncertainty is . If a quantity is defined as a constant fraction of a measured value, its uncertainty scales by the same fraction.
...
Using your group walking speed, , and the time available for walking, , estimate the maximum distance a typical person could walk in that available time.
Propagate the uncertainties using . Report your result in the form: 
